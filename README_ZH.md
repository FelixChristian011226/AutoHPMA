...
- 启动游戏。如果您使用的是 Mumu 模拟器，请全屏显示。
- 根据您的偏好配置该应用程序。
- 选择启动方法，然后在准备就绪后单击开始按钮。

<br>

## 注意事项

- **兼容性**：AutoHPMA 目前仅与 MuMu 模拟器兼容，支持分辨率为 2560\*1600 或者 1920\*1080 的窗口化全屏模式。目前不支持官方启动器和其他分辨率。
- **说明**：在脚本执行期间，请勿最小化窗口或单击显示桌面按钮，否则可能会导致功能失效。然而窗口之间的遮挡是允许的。
